...
function blogposts () {
  const result = []
  result.push('<iframe width="400px" height="320px" src="https://www.youtube.com/embed/gx6TBrfCW54?loop=1&playlist=gx6TBrfCW54" frameborder="0" allow="autoplay; encrypted-media"></iframe>')
  ...
  result.push(`<video src="/dist/me.webm" autoplay loop width="400px" height="320px" />`)
  result.push('<iframe width="400px" height="320px" src="https://www.youtube.com/embed/GULItNlBvJc?loop=1&playlist=GULItNlBvJc" frameborder="0" allow="autoplay; encrypted-media"></iframe>')
  for (let i = 52; i < 300; i++) {
    const artefact = `<div style="overflow:scroll;opacity:0.3;width:400px; height:320px;background-color:white; color:black; font-size:xx-large">People read books to learn, to answer questions, to enjoy a good story, and to improve themselves. And perhaps no book provides these benefits as well as does the best-selling book in the world, the Holy Bible.
